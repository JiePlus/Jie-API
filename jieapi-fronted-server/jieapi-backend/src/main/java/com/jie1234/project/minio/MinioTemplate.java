...
public class MinioTemplate {
     ...
     */
    @SneakyThrows
    public OssFile putObject(InputStream inputStream, String bucketName, String originalFileName, String type, Long id) {
        String uuidFileName = generateOssUuidFileName(originalFileName, type, id);
        try {
     ...
     */
    @SneakyThrows
    public String getPresignedObjectUrlRead(String bucketName, String ossFilePath) {
     ...
     * @return 
     */
    public String generateOssUuidFileName(String originalFilename, String type, Long id) {
        return "files" + StrUtil.SLASH + DateUtil.format(new Date(), "yyyy-MM-dd") + StrUtil.SLASH +type + StrUtil.SLASH + id + StrUtil.SLASH + originalFilename;
    }
